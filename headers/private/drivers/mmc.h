...
#define MMC_COMMAND_FLAG 0x80

enum MMC_COMMANDS {
	MMC_GO_IDLE_STATE			= 0,
	MMC_SEND_OP_COND			= 1,
	MMC_ALL_SEND_CID			= 2,
	MMC_SET_RELATIVE_ADDR		= 3 | MMC_COMMAND_FLAG,
	MMC_SWITCH					= 6 | MMC_COMMAND_FLAG,
	MMC_SELECT_DESELECT_CARD	= 7,
	MMC_SEND_EXT_CSD			= 8 | MMC_COMMAND_FLAG,
	MMC_SEND_CSD				= 9,
	MMC_STOP_TRANSMISSION		= 12,
	MMC_SET_BLOCKLEN			= 16,
	MMC_READ_SINGLE_BLOCK		= 17,
	MMC_READ_MULTIPLE_BLOCKS	= 18,
	MMC_WRITE_SINGLE_BLOCK		= 24,
	MMC_WRITE_MULTIPLE_BLOCKS	= 25,
