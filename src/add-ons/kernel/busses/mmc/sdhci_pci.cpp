...
static const PciIdMatch kSupportedDevices[] = {
	...
	{ 0x8086, 0x0f14, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Bay Trail eMMC
	{ 0x8086, 0x0f15, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Bay Trail SDIO
	{ 0x8086, 0x0f16, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Bay Trail SD
	{ 0x8086, 0x2294, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Braswell eMMC
	{ 0x8086, 0x2296, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Cherry Trail eMMC
	{ 0x8086, 0x5aca, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_BROKEN_AUTO_STOP | SDHCI_QUIRK_PREFER_1V8 }, // Intel Apollo Lake eMMC
	{ 0x8086, 0x5acc, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_BROKEN_AUTO_STOP | SDHCI_QUIRK_PREFER_1V8 }, // Intel Apollo Lake SD
	{ 0x8086, 0x31b4, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Gemini Lake eMMC
	{ 0x8086, 0xa0c4, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Tiger Lake eMMC
	{ 0x8086, 0x4dc4, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Jasper Lake eMMC
	{ 0x8086, 0x4b47, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Elkhart Lake eMMC
	{ 0x8086, 0x54c4, SDHCI_QUIRK_INTEL_POWER_UP_RESET | SDHCI_QUIRK_WAIT_FOR_POWER | SDHCI_QUIRK_MISSING_CAPS | SDHCI_QUIRK_PREFER_1V8 }, // Intel Alder Lake N-Series eMMC
